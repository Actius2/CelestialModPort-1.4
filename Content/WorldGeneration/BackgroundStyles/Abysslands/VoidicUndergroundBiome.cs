...
{
	public class VoidicUndergroundBiome : ModBiome
	{
		// Select all the scenery
		public override ModUndergroundBackgroundStyle UndergroundBackgroundStyle => ModContent.Find<ModUndergroundBackgroundStyle>("CelestialMod/Content/WorldGeneration/BackgroundStyles/Abysslands/VoidicUndergroundBackgroundStyle");

		// Select Music
		public override int Music => MusicLoader.GetMusicSlot(Mod, "Assets/Music/VoidMusic2");
		...
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Abysslands Underground");
		}
		...
		public override bool IsBiomeActive(Player player) {
			...
			return (player.ZoneRockLayerHeight || player.ZoneDirtLayerHeight) &&
				...
				ModContent.GetInstance<VoidicBiomeTileCount>().VoidicTileCount >= 40 &&
