...
{
    public class VoidicSapling : ModTile
	{
		public override void SetStaticDefaults() {
			...
			TileObjectData.newTile.AnchorValidTiles = new[] { ModContent.TileType<VoidicGrass>() };
			...
			DustType = ModContent.DustType<TemporalDust>();
