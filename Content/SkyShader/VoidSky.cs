...
namespace CelestialMod.Content.SkyShader
{
    public class VoidSky : CustomSky
    {
        ...
        {
            Texture2D MeteorTexture = (Texture2D)ModContent.Request<Texture2D>("CelestialMod/Content/SkyShader/VoidMeteor");
            Texture2D SkyTex = (Texture2D)ModContent.Request<Texture2D>("CelestialMod/Content/SkyShader/VoidBg");
            ...
            {
                Vector2 value4 = new(1f / Meteors[j].Depth, 0.9f / Meteors[j].Depth);
